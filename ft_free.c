...
/*   Updated: 2020/02/10 13:56:10 by novan-ve      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

int		ft_free_img(t_data *d, int x)
{
	...
	ft_free_sprite(d->p, "Exited cleanly", d->p->isprite - 1, x);
	return (0);
}
...
int		ft_free_img2(t_data *data, char *s, int x)
{
	...
	ft_free_sprite(data->p, s, data->p->isprite - 1, x);
	return (0);
}
